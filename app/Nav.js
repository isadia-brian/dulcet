...
const Nav = () => {
  ...
  return (
    <div className={`${poppins.className} relative bg-white`}>
      ...
      <div
        className={`absolute  w-[150px] z-[1500] left-0 bg-gray-200 px-4 py-6 top-0 h-full transform transition-transform ${
          navOpen
